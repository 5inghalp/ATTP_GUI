      ...
      <main className="flex-1 overflow-hidden relative z-10">
        ...
        >
          <div className="h-full flex">
            ...
            <aside className="w-72 border-r border-border/50 bg-sidebar flex flex-col shadow-sm overflow-hidden h-full">
              {sessionList}
            </aside>
            ...
            <aside className="w-80 border-l border-border/50 bg-sidebar/50 flex flex-col p-3 gap-3 overflow-hidden h-full">
              {/* Top - Reasoning Panel */}
